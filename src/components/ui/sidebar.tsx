...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-2 py-2 hidden md:flex md:flex-col w-[300px] rounded-full flex-shrink-0",
        className
      )}
      animate={{
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0 p-10 z-[100] flex flex-col justify-between bg-[#FFF0ED]",
                className
              )}
              {...props}
            >
